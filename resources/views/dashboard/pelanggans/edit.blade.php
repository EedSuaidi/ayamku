<x-layout>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/dashboard/pelanggans/{{ $pelanggan->id }}" method="POST" id="pelanggan-form">
                    @method('put')
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    value="{{ old('nama', $pelanggan->nama) }}" id="nama" name="nama"
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none;" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                                    rows="3" required>{{ old('alamat', $pelanggan->alamat) }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nomor_telepon') is-invalid @enderror"
                                    value="{{ old('nomor_telepon', $pelanggan->nomor_telepon) }}" id="nomor-telepon"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('saldo') is-invalid @enderror"
                                        value="{{ old('saldo', $pelanggan->saldo) }}" id="saldo" name="saldo"
